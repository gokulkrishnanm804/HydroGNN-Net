...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/alerts',   icon: Bell,     label: 'Alerts',        badge: '3',  badgeVariant: 'danger' },
        ...
        {NAV_GROUPS.map((group) => (
          <div key={group.label} className={styles.navGroup}>
            ...
            {group.items.map((item) => {
              ...
              const badgeStyle = item.badgeVariant ? BADGE_COLORS[item.badgeVariant] : null;
              return (
                <Link key={item.href} href={item.href} style={{ textDecoration: 'none' }}>
                  ...
                  >
                    ...
                    <AnimatePresence>
                      {!collapsed && item.badge && badgeStyle && (
                        <motion.span
